...
internal static class SubscriptionEndpoints
{
    public static void Map(IEndpointRouteBuilder app)
    {
            ...
            AppDbContext db) =>
        {
            ...
            // bumps Subscription.NextDueOn, and then recomputes balances. Wrap so a
            // crash can't leave a transaction inserted but the subscription's
            // NextDueOn not advanced (or vice versa).
